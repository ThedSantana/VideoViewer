...
public class CustomExoPlayerView extends FrameLayout {
    ...
    public CustomExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.custom_player, this);
    ...
    public void setFullScreenListener(CustomPlaybackControlView.FullScreenListener listener) {
